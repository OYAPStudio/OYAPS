...
async function getMemberData(username: string): Promise<MemberData | null> {
  const mockMembers: Record<string, MemberData> = {
    'ali': {
      username: 'ali',
      fullName: 'Ali Saad Izaldeen',
      avatar: '/team/ali.png',
      email: 'ali@oyaps.com',
      phone: '+964 770 161 3172',
      university: 'Northern Technical University University',
      graduationYear: 2028,
      ...
      skills: ['JavaScript', 'React', 'Node.js', 'TypeScript', 'CyberSecurity'],
      social: {
    ...
    'yousif': {
      username: 'yousif',
      fullName: 'Yousif Abdlwahab',
      avatar: '/team/Yousif.jpg',
      email: 'yousif@oyaps.com',
      phone: '+964 770 160 5766',
      university: 'Northern Technical University University',
      graduationYear: 2028,
      department: 'Cybersecurity Engineering',
      location: 'Mosul, Iraq',
    ...
    'ezalden': {
      username: 'ezalden',
      fullName: 'Ezzaldeen Mamoon Ezzaldeen',
      avatar: '/team/Ezalden.JPG',
      email: 'Ezzaldeen@oyaps.com',
      phone: '+964 772 690 7123',
      university: 'Northern Technical University University',
      graduationYear: 2028,
      department: 'Cybersecurity Engineering',
      location: 'Mosul, Iraq',
